...
async function cargarDatos2025() {
  try {
    console.log('📊 Cargando datos de 2025 desde la tabla del usuario...\n');
    ...
    const responseVerificacion = await axios.get(`${BASE_URL}/api/danos-acumulados?anio=2025`);
    ...
    if (responseVerificacion.data.success) {
      ...
      console.log(`💰 Total Real 2025: $${totalReal.toLocaleString()}`);
      console.log(`💰 Total Presupuesto 2025: $${totalPpto.toLocaleString()}`);
    }

    console.log('\n✅ Carga de datos 2025 completada exitosamente');
